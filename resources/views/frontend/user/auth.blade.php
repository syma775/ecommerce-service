...
<div class="banner1">
			<div class="container">
				<h3><a href="{{ url('/') }}">Home</a> / <span>User</span></h3>
			</div>
		</div>
	<!--banner-->
				...
				<div class="row">
					<div class="col-md-5" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; height:100vh; margin-top:100px; padding:30px;margin-bottom:30px;">
					       @if(session()->has('success'))
					          ...
					          @endif
					<h3 style="margin-top:30px; margin-bottom:20px;"> User Login</h3>
					...
					<div class="col-md-5" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; height:100vh; margin-top:100px;padding:30px;margin-bottom:30px;">
							@if(session()->has('success'))
					          <div class="alert alert-success">{{ session()->get('success')}}</div>
					          @endif
					<h3 style="margin-top:30px;margin-bottom:20px;">User Registration From</h3>
					<form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
						...
						<label>Phone</label>
						<div class="form-group">
							<input type="string" class="form-control" name="phone" placeholder="Enter your phone"/>
						</div>
