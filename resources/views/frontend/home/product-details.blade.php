							...
							<div clas="single-top">
								<div class="single-left">
									<div class="flexslider">
										<ul class="slides">
                                        @foreach(json_decode($products->multi_image) as $product)
                                            <li data-thumb="{{ asset('/gallery/'.$product) }}">
                                                    <div class="thumb-image"> <img src="{{ asset('/gallery/'.$product) }}" data-imagezoom="true" class="img-responsive"> </div>
                                            </li>
								...
								<div class="single-right simpleCart_shelfItem">
									...
									<p class="price item_price">{{ $products->price }}</p>
									<div class="description">
										<p><span>Quick Overview : </span>{{ $products->short_description  }}</p>
									</div>
									<form action="{{ url('/add/to/cart') }}" method="post">
											...
											<div class="women">
												<h6><a href="{{ url('/product/details/'.$products->id) }}">{{ $products->name }}</a></h6>
												<span class="size">Size : {{ $products->size->name }}</span>
												<p ><em class="item_price">Price : ${{ $products->price }}</em></p>
												Quentity: <input type="number" name="qty" min="1" value="1"style="margin-bottom:20px;color:black;"/><br/>
												@if(auth()->check())
												  @if($products->qty > 0)
											...
											<div id="myTabContent" class="tab-content">
												<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
													<div class="descr">
														...
														<p class="quote">{{ $products->long_description  }}.</p>
															<div class="video">
												...
												<div role="tabpanel" class="tab-pane fade" id="reviews" aria-labelledby="reviews-tab">
													<div class="descr">
														...
														@else
														  <p>
															<a href="{{ url('/user/register') }}" class="btn btn-warning">Login</a>
														  </p>
														@endif
