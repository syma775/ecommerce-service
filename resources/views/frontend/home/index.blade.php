...
@section('content')
		...
		<div class="content">
										...
										<div  class="grid-arrival">
											<figure>		
												<a href="{{ url('/product/details/'.$product->id) }}" class="new-gri">
													<div class="grid-img">
														<img  src="{{ asset('/product/'.$product->image) }}" class="img-responsive" style="width:150px;height:100px" alt="">
													</div>
													<div class="grid-img">
														<img  src="{{ asset('/product/'.$product->image) }}" class="img-responsive" style="width:150px;height:100px" alt="">
													</div>			
			...
			<!--accessories-->
			<!--Products-->
				<div class="product-agile" style="background-color:white;">
...
<!--discount-->
			<div class="product-agile" style="background-color:white;">
					<div class="container" style="background-color:white;">
						<h3 class="tittle1"> Discount Products</h3>
						<div class="slider">
							<div class="callbacks_container">
								<ul class="rslides" id="slider">
									<li>	 
				...
				<!-- <div class="new-arrivals-w3agile">
					<div class="container">
						<h3 class="tittle1">Discounted Products</h3>
						<div class="arrivals-grids">
							@foreach ($discount_products as $product)
							<div class="col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
