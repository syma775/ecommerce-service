  ...
  <div class="container-fluid">
    <div class="col-md-12">
        <div class="row">
            ...
            @endif
                <div class="card">
                    <h4 style="text-align:center;  margin-top:30px;">Subcategory Update</h4>
                    <div class="card-body">
                        <form action="{{ url('/subcategory/update/'.$subcategory->id)}}" method="post"  enctype="multipart/form-data">
                            @csrf
